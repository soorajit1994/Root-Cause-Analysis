$(document).ready(function() {
  ...
  document.addEventListener("DOMContentLoaded", function(event) {
    var phrases = shuffleArray(["Connecting to Jenkins", "Retrieving latest builds", "Fetching Logs", "Getting Job Details", "Almost There","Have patience","Analysing Passed Scenarios","Fetching Failed Scenarios","Retrieving current Jobs","Prepearing Reports","Predicting.."]);
